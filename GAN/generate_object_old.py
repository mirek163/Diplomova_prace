...
def generate_object(weight_file, output_file=os.path.join(SAVE_DIR, "generated1.obj")):
    ...
    #print(np.sum(generated_voxel==0))
    for i in range(32):
        print(np.sum(generated_voxel[i,:,:]))
    generated_voxel[0,0,0]=True
    generated_voxel[31,31,31]=True
    fig = plt.figure()
...
if __name__ == "__main__":
    weight_path = "weights/generator_1000-100_32_0.0002.pth"
